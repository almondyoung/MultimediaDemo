package com.hugo.openglvideorecord.media;
...
import com.hugo.openglvideorecord.base.BaseGLSL;
import com.hugo.openglvideorecord.core.FrameBuffer;
import com.hugo.openglvideorecord.core.IObserver;
import com.hugo.openglvideorecord.core.Observable;
import com.hugo.openglvideorecord.core.RenderBean;
import com.hugo.openglvideorecord.core.Renderer;
import com.hugo.openglvideorecord.egl.EGLConfigAttrs;
import com.hugo.openglvideorecord.egl.EGLContextAttrs;
import com.hugo.openglvideorecord.egl.EglHelper;

/**
 * VideoSurfaceProcessor 视频流图像处理类，以{@link TextureProvider}作为视频流图像输入。
 * 通过设置{@link com.hugo.openglvideorecord.core.IObserver}
 * 来接收处理完毕的{@link com.hugo.openglvideorecord.core.RenderBean}，并做相应处理，诸如展示、编码等。
 */
